...
#define typedef_t __packed typedef					///<结构体字节对齐宏定义
#define SOFTWARE_VERSION "03010101"					///<MCU软件版本号
#define HARDWARE_VERSION "03010100"					///<MCU软件版本号

#define GIZWITS_LOG printf             				///<日志打印宏定义printf
#define PROTOCOL_DEBUG                			///<协议数据打印

#ifndef ICACHE_FLASH_ATTR							///<使用esp8266需定义的
#define ICACHE_FLASH_ATTR
#endif

#define REPORT_TIME_MAX 6000 						///<设备状态数据上报间隔时间宏定义 6s
...
#define SEND_MAX_TIME       2000                    ///< 2s重发
#define SEND_MAX_NUM        2                       ///< 重发次数 2次
...
#define PRODUCT_KEY "7156f5e66e654257b54e2266fcc36da5"		///<Product Key (产品标识码)
#define PRODUCT_SECRET "82ba5583040545ceb571efc4520dc11e"	///<Product Secret (产品密钥)

#define MAX_PACKAGE_LEN    (sizeof(devStatus_t)+10)         ///< 数据缓冲区最大长度
#define RB_MAX_LEN          (MAX_PACKAGE_LEN*2)     		///< 环形缓冲区最大长度


#define V_HCHO_RATIO                         0.01			///<分辨率
#define V_HCHO_ADDITION                      0				///<增量 机智云官方手册有详述
#define V_HCHO_MIN                           0				///<X的最小值
#define V_HCHO_MAX                           200			///<X的最大值

#define V_TEMPER_RATIO                       0.1
#define V_TEMPER_ADDITION                    -20
#define V_TEMPER_MIN                         0
#define V_TEMPER_MAX                         800

#define V_HUMID_RATIO                        0.1
#define V_HUMID_ADDITION                     20
#define V_HUMID_MIN                          0
#define V_HUMID_MAX                          750

#define V_PM25_RATIO                         0.1
#define V_PM25_ADDITION                      0
#define V_PM25_MIN                           0
#define V_PM25_MAX                           1200
...
typedef_t struct {
  uint8_t valueV_Hcho;
  uint16_t valueV_Temper;
  uint16_t valueV_Humid;
  uint16_t valueV_Pm25;
} devStatus_t; 
